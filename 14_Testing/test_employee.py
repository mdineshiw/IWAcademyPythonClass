...
class TestEmployee(unittest.TestCase):
	...
	def test_email(self):
		...
		self.assertEqual(emp_1.email, "Dinesh.Mishra@gmail.com")
		self.assertEqual(emp_2.email, "Ram.Prasad@gmail.com")

		emp_1.first = "John"
		emp_2.first = "Jane"

		self.assertEqual(emp_1.email, "John.Mishra@gmail.com")
	...
	def test_fullname(self):
		...
		self.assertEqual(emp_1.fullname, "Dinesh Mishra")
		self.assertEqual(emp_2.fullname, "Ram Prasad")

		emp_1.first = "John"
		emp_2.first = "Jane"

		self.assertEqual(emp_1.fullname, "John Mishra")
