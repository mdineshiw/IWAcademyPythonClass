...
class TestEmployee(unittest.TestCase):
	...
	def setUp(self):
		self.emp_1 = Employee("Dinesh", "Mishra", 50000)
	...
	def test_email(self):
		...
		self.assertEqual(self.emp_1.email, "Dinesh.Mishra@gmail.com")
		self.assertEqual(self.emp_2.email, "Ram.Prasad@gmail.com")

		self.emp_1.first = "John"
		self.emp_2.first = "Jane"

		self.assertEqual(self.emp_1.email, "John.Mishra@gmail.com")
		self.assertEqual(self.emp_2.email, "Jane.Prasad@gmail.com")

	def test_fullname(self):

		self.assertEqual(self.emp_1.fullname, "Dinesh Mishra")
		self.assertEqual(self.emp_2.fullname, "Ram Prasad")

		self.emp_1.first = "John"
		self.emp_2.first = "Jane"

		self.assertEqual(self.emp_1.fullname, "John Mishra")
